...
? 'block w-full pl-3 pr-4 py-2 border-l-4 border-secondary-400 dark:border-secondary-600 text-left text-base font-medium
text-secondary-700 dark:text-secondary-300 bg-secondary-50 dark:bg-secondary-900/50 focus:outline-none
focus:text-secondary-800 dark:focus:text-secondary-200 focus:bg-secondary-100 dark:focus:bg-secondary-900
focus:border-secondary-700 dark:focus:border-secondary-300 transition duration-150 ease-in-out'
